...
String parameterToString(dynamic value) {
  ...
  if (value is Breed) {
    return BreedTypeTransformer().encode(value).toString();
  }
  if (value is Color) {
    return ColorTypeTransformer().encode(value).toString();
  }
  if (value is Environment) {
    return EnvironmentTypeTransformer().encode(value).toString();
  }
  if (value is Personality) {
    return PersonalityTypeTransformer().encode(value).toString();
  }
  if (value is Title) {
    return TitleTypeTransformer().encode(value).toString();
  }
