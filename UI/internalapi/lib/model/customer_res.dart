...
class CustomerRes {
  ...
  @override
  String toString() => 'CustomerRes[id=$id, email=$email, firstName=$firstName, lastName=$lastName, title=$title, birthDate=$birthDate, socialSecurityNumber=$socialSecurityNumber, taxId=$taxId, address=$address, bankDetails=$bankDetails]';
