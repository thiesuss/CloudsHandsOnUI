...
void main() {
  // final instance = CustomerApi();

  group('tests for CustomerApi', () {
    ...
    test('test getCustomerContracts', () async {
      // TODO
    });
    ...
    // Update a customer
    //
    //Future updateCustomer(String customerId, CustomerReq customerReq) async
